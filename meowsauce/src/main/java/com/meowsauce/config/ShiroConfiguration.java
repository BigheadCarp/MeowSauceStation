...
import com.meowsauce.filter.URLPathMatchingFilter;
import com.meowsauce.realm.MeowRealm;
...
public class ShiroConfiguration {
    ...
    @Bean
    public MeowRealm getWJRealm() {
        MeowRealm meowRealm = new MeowRealm();
        meowRealm.setCredentialsMatcher(hashedCredentialsMatcher());
        return meowRealm;
    }
